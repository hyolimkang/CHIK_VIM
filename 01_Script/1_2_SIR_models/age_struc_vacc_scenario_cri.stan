...
parameters {
  ...
  real<lower=0, upper=8> base_beta[T];
  
  // Other parameters
  real<lower=0,   upper=0.4> rho;    // Detection probability
  real<lower=19,  upper=21>  shape;  // Overdispersion
...
model {
  ...
  // overdispersion
  shape ~ uniform(19, 21);  // originally (17,18)
